...
// ./instruction_decoder 00000001001010000100100000101010
//
// The output returned from the program should be: slt $t1, $t1, $t0
//
...
void print_func_0(char* bit_string, int func_code){
   unsigned rd, rs, rt, offset;
   switch(func_code){
      case 1:
         printf("bgez ");
         // rs = 21-25
...
void decode_opcode(char* bit_string){
   ...
   switch(opcode){
      ...
      case 1:
         ...
         func_code = parse_bits(bit_string, 16, 20);
         print_func_0(bit_string, func_code);
         break;
      default:
         //printf("Error: Bad operator.\n");
         break;
