...
namespace Project3
{
    ...
    {
        public List<SeasonInfo> seasonInfoList = new List<SeasonInfo>();
        ...
        public void collectData(BackgroundWorker backgrndWrkrObj)
        {
            ...
            if(seasonInfoList.Count > 0) { seasonInfoList.Clear(); }
            ...
            for (int i = 0; i < urlList.Count; i++)
            {
                ...
                try
                {
                    ...
                    seasonInfoList.Add(seasonInfoObj);
                    backgrndWrkrObj.ReportProgress(seasonInfoList.Count);
                }
                catch (Exception ex)
                {
